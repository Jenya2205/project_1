...
import 'package:rumbella/pages/about_screen_privacy_policy/components/about_screen_privacy_policy_body.dart';

class AboutUsScreenPrivacyPolicy extends StatelessWidget {
  const AboutUsScreenPrivacyPolicy({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        const AboutScreenPrivacyPolicyBody()
      ],
    );
  }
}
