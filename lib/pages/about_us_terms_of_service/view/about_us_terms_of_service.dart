...
import 'package:rumbella/pages/about_us_terms_of_service/components/about_us_terms_of_service_body.dart';

class AboutUsScreenTermsOfService extends StatelessWidget {
  const AboutUsScreenTermsOfService({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        const AboutUsTermsOfServiceBody()
      ],
    );
  }
}
