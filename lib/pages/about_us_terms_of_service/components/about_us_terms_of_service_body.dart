...
class AboutUsTermsOfServiceBody extends StatelessWidget {
  const AboutUsTermsOfServiceBody({Key? key}) : super(key: key);
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(left: 80.0 * DeviceInfo.w),
                  child: Text(
                    "Terms of service",
                    style: TextStyle(
