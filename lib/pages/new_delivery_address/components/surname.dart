...
class NewDeleveryAddressSurname extends StatelessWidget{
  const NewDeleveryAddressSurname({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: TextField(
              onChanged: (value) {
                context.read<StateNewDeliveryAddress>().onChangedSurname(value);
              },
