...
class NewDeliveryAddressName extends StatelessWidget{
  const NewDeliveryAddressName({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: TextField(
              onChanged: (value) {
                context.read<StateNewDeliveryAddress>().onChangedName(value);
              },
