...
class SignInScreenPassword extends StatelessWidget {
  const SignInScreenPassword({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: TextField(
              obscureText: context.watch<StateSignInScreen>().obscureTextState,
              ...
              style: TextStyle(
                  ...
                  fontSize: 15.0 * DeviceInfo.w),
              onChanged: (value) {
                context.read<StateSignInScreen>().onChangedPassword(value);
              },
              decoration: InputDecoration(
                suffixIcon: Material(
                  color: Colors.transparent,
                  child: InkWell(
                    onTap: context.read<StateSignInScreen>().changeObscureState,
